...
def min_cost_matching(
    ...
    unmatched_detections.extend(
        detection_idx
        for col, detection_idx in enumerate(detection_indices) if col not in col_indices
    )

    unmatched_tracks.extend(
        track_idx for row, track_idx in enumerate(track_indices) if row not in row_indices
    )
